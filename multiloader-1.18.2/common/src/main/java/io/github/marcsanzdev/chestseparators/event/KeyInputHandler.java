...
public class KeyInputHandler {
    ...
    private static void triggerAutoDeposit(Minecraft client, int action) {
        if (client.player == null || !NetworkManager.canServerReceive(AutoDepositRequestPayload.ID)) return;
    ...
    private static Component label(boolean on, String onKey, String offKey) {
        return new net.minecraft.network.chat.TranslatableComponent(on ? onKey : offKey);
    }
