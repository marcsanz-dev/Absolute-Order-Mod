...
public class ScreenColorPicker extends AbstractEditorScreen {
    ...
    protected void buildWidgets() {
        ...
        WideButtonWidget btnEyedropper = new WideButtonWidget(
                ...
                85,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.eyedropper").getString(),
        ...
        btnEyedropper.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.eyedropper").getString();
        ...
        WideButtonWidget btnExit = new WideButtonWidget(
                ...
                55,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.exit").getString(),
        ...
        btnExit.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.exit").getString();
        ...
        hexField = new EditBox(
                client.font, fieldX, fieldY, 60, 12, new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.hex"));
        ...
        rField = new EditBox(
                client.font, fieldX, fieldY + 20, 30, 12, new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.color_r"));
        ...
        gField = new EditBox(
                client.font, fieldX, fieldY + 36, 30, 12, new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.color_g"));
        ...
        bField = new EditBox(
                client.font, fieldX, fieldY + 52, 30, 12, new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.color_b"));
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        Component titleText = new net.minecraft.network.chat.TranslatableComponent("window.chestseparators.edit_color").withStyle(ChatFormatting.BOLD);
        ...
        Component instructionText = new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.color_picker.instructions")
        ...
        if (hexField != null) hexField.render(context.pose(), mouseX, mouseY, delta);
        if (rField != null) rField.render(context.pose(), mouseX, mouseY, delta);
        if (gField != null) gField.render(context.pose(), mouseX, mouseY, delta);
        if (bField != null) bField.render(context.pose(), mouseX, mouseY, delta);
