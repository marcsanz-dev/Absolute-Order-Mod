...
public record WhitelistS2CPayload(BlockPos pos, Map<Integer, SlotWhitelist> whitelists) implements CsPayload {

    public static final ResourceLocation ID = new ResourceLocation("chestseparators", "whitelist_sync_s2c");

    public static WhitelistS2CPayload read(FriendlyByteBuf buf) {
