...
public final class MagnifierRenderer {
    ...
    public static void render(GuiGraphicsExtractor context, int cursorX, int cursorY, boolean circle) {
        ...
        context.outline(loupeCx - half, loupeCy - half, half * 2, half * 2, 0xFFFFFFFF);
    ...
    private static void drawCircleOutlineAA(GuiGraphicsExtractor context, int cx, int cy, int r, int color) {
    ...
    private static void drawRingFrame(GuiGraphicsExtractor context, int cx, int cy, int rInner, int rOuter, int color) {
        int rgb = color & 0x00FFFFFF;
    ...
    private static void drawSquareFrame(GuiGraphicsExtractor context, int cx, int cy, int rInner, int rOuter, int color) {
