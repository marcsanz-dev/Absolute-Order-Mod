...
final class ColorPickerInputHandler {
    ...
    boolean onKeyPressed(net.minecraft.client.input.KeyEvent input) {
        if (!session.isColorPickerOpen) return false;
        ...
        if (isAnyFieldFocused) {
            ...
            if (screen.hexField != null && screen.hexField.isFocused()) screen.hexField.keyPressed(input);
            else if (screen.rField != null && screen.rField.isFocused()) screen.rField.keyPressed(input);
            else if (screen.gField != null && screen.gField.isFocused()) screen.gField.keyPressed(input);
            else if (screen.bField != null && screen.bField.isFocused()) screen.bField.keyPressed(input);
    ...
    boolean onCharTyped(net.minecraft.client.input.CharacterEvent input) {
        if (!session.isColorPickerOpen) return false;
        if (screen.hexField != null && screen.hexField.isFocused()) return screen.hexField.charTyped(input);
        if (screen.rField != null && screen.rField.isFocused()) return screen.rField.charTyped(input);
        if (screen.gField != null && screen.gField.isFocused()) return screen.gField.charTyped(input);
        if (screen.bField != null && screen.bField.isFocused()) return screen.bField.charTyped(input);
        return false;
    }
}
