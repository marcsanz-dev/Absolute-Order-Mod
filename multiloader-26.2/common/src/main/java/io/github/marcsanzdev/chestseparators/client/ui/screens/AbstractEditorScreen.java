...
public abstract class AbstractEditorScreen implements IEditorSubScreen {
    ...
    protected void drawCheckerboard(GuiGraphicsExtractor context, int x, int y, int width, int height, int squareSize) {
    ...
    protected void drawBaseBevel(
            GuiGraphicsExtractor context, int x, int y, int width, int height, int light, int dark, int shadow, boolean sunken) {
        if (sunken) {
    ...
    protected void drawColorBevel(
            GuiGraphicsExtractor context, int x, int y, int width, int height, int baseColor, boolean sunken) {
    ...
    protected void drawStandardBevel(GuiGraphicsExtractor context, int x, int y, int width, int height, boolean sunken) {
