...
public class ScreenViewGroups extends AbstractEditorScreen {
    ...
    public void renderWhitelistPreviewPanel(GuiGraphicsExtractor context, int mouseX, int mouseY) {
    ...
    private void renderConflictPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        context.centeredText(client.font, title, 0, 0, 0xFFFF5555);
    ...
    private void renderSelectionOverlay(GuiGraphicsExtractor context) {
