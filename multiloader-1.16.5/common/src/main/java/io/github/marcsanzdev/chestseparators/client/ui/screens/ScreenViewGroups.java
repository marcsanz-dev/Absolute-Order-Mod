...
public class ScreenViewGroups extends AbstractEditorScreen {
    ...
    protected void buildWidgets() {
        ...
        WideButtonWidget btnEditFilter = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.edit_filter").getString(),
                ModTextures.ICON_SM_FILTER,
                () -> {
                    editor.playClickSound(1.0f);
                    if (session.selectedSlots.isEmpty()) {
                        editor.showStatus(new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.select_first"), ChatFormatting.RED);
                        return;
                    }
        ...
        btnEditFilter.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.edit_filter").getString();
        ...
        WideButtonWidget btnClearAll = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.delete_all_filters").getString(),
                ...
                () -> {
                    ...
                    if (whitelists != null && !whitelists.isEmpty()) {
                        ...
                        editor.showStatus(
                                new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.all_filters_deleted"), ChatFormatting.RED);
                        editor.playClickSound(0.8f);
                    }
                });
        btnClearAll.tooltipText = new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.delete_all_filters")
                .getString();
        ...
        WideButtonWidget btnAreaSelect = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.area_select").getString(),
        ...
        btnAreaSelect.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.area_select").getString();
        ...
        WideButtonWidget btnTraceSelect = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.trace_select").getString(),
        ...
        btnTraceSelect.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.trace_select").getString();
        ...
        WideButtonWidget btnClearSelect = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.clear_selection").getString(),
                ModTextures.ICON_SM_TRASH,
                () -> {
        ...
        btnClearSelect.tooltipText = new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.clear_selection")
                .getString();
        ...
        WideButtonWidget btnCopy = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.copy_filters").getString(),
                ...
                () -> {
                    ...
                    editor.showStatus(new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.filters_copied"), ChatFormatting.GRAY);
                    editor.playClickSound(1.0f);
                });
        btnCopy.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.copy_filters").getString();
        ...
        WideButtonWidget btnPaste = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.paste_filters").getString(),
                ...
                () -> {
                    ...
                    if (ChestConfigManager.getInstance().hasWhitelistClipboardData()) {
                        ...
                        editor.showStatus(
                                new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.filters_pasted"), ChatFormatting.GREEN);
                        editor.playClickSound(1.0f);
                    }
                });
        btnPaste.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.paste_filters").getString();
        ...
        WideButtonWidget btnUndo = new WideButtonWidget(
                ...
                halfW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.undo").getString(),
        ...
        btnUndo.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.undo").getString();
        ...
        WideButtonWidget btnRedo = new WideButtonWidget(
                ...
                halfW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.redo").getString(),
        ...
        btnRedo.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.redo").getString();
    ...
    private void buildPopupWidgets() {
        ActionIconButtonWidget btnOverwrite = new ActionIconButtonWidget(
                ...
                16,
                "1. "
                        + new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.conflict.overwrite")
                                .getString(),
                null,
                0xFF852D2D,
                () -> {
        ...
        btnOverwrite.tooltipText = new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.conflict.overwrite")
                .getString();
        ...
        ActionIconButtonWidget btnDeselect = new ActionIconButtonWidget(
                ...
                16,
                "2. "
                        + new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.conflict.deselect")
                                .getString(),
                null,
                0xFF2D852D,
                () -> {
                    ...
                    if (!session.selectedSlots.isEmpty()) {
                        ...
                        editor.showStatus(new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.empty_selection"), ChatFormatting.RED);
                    }
                });
        btnDeselect.tooltipText = new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.conflict.deselect")
                .getString();
        ...
        btnCancel.tooltipText = new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.conflict.cancel")
                .getString();
    ...
    private void renderConflictPopup(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        Component title = new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.conflict_title");
        ...
        Component desc = new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.conflict_desc");
