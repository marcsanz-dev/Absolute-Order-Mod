...
public class ScreenDrawLines extends AbstractEditorScreen {
    ...
    protected void buildWidgets() {
        ...
        WideButtonWidget btnCopy = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.copy_layout").getString(),
                ModTextures.ICON_SM_COPY,
                () -> {
                    btnCopyClickTime = System.currentTimeMillis();
                    ChestConfigManager.getInstance().copyAllToClipboard();
                    editor.showStatus(new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.layout_copied"), ChatFormatting.GRAY);
                    editor.playClickSound(1.0f);
                });
        btnCopy.keepNormalTextColor = true;
        btnCopy.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.copy_layout").getString();
        btnCopy.texSize = 128;
        widgets.add(btnCopy);
        ...
        WideButtonWidget btnPaste = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.paste_layout").getString(),
                ...
                () -> {
                    ...
                    if (ChestConfigManager.getInstance().hasClipboardData()) {
                        ...
                        editor.saveSmart();
                        editor.showStatus(new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.layout_pasted"), ChatFormatting.GREEN);
                        editor.playClickSound(1.0f);
                    }
                });
        btnPaste.keepNormalTextColor = true;
        btnPaste.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.paste_layout").getString();
        ...
        WideButtonWidget btnUndo = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.undo_action").getString(),
        ...
        btnUndo.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.undo_action").getString();
        btnUndo.texSize = 128;
        widgets.add(btnUndo);
        ...
        WideButtonWidget btnRedo = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.redo_action").getString(),
        ...
        btnRedo.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.redo_action").getString();
        btnRedo.texSize = 128;
        widgets.add(btnRedo);
        ...
        btnPencilArea = new ToolButtonWidget(
                ...
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.draw_area").getString(),
                () -> selectPaintTool(0));
        ...
        btnEraserArea = new ToolButtonWidget(
                ...
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.erase_area").getString(),
                () -> selectEraseTool(0));
        ...
        btnClear = new ToolButtonWidget(
                ...
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.clear_lines").getString(),
                () -> {
                    ...
                    editor.saveSmart();
                    editor.showStatus(new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.cleared"), ChatFormatting.RED);
        ...
        btnPencilTrace = new ToolButtonWidget(
                ...
                row2Y,
                ModTextures.PENCIL_BASE,
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.draw_trace").getString(),
                () -> selectPaintTool(1));
        ...
        btnEraserTrace = new ToolButtonWidget(
                ...
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.erase_trace").getString(),
                () -> selectEraseTool(1));
        ...
        btnColorPicker = new ToolButtonWidget(
                ...
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.open_palette").getString(),
                () -> {
    ...
    private void updateWidgetStates() {
        ...
        btnClear.tooltipText = new net.minecraft.network.chat.TranslatableComponent(
                        tabMode == 0
    ...
    private void drawPaletteArea(GuiGraphics context, int mouseX, int mouseY, int tabMode) {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            if (!session.isColorPickerOpen
                ...
                context.renderTooltip(
                        ...
                        new net.minecraft.network.chat.TranslatableComponent("color.minecraft." + STANDARD_COLOR_KEYS[i]),
                        mouseX,
                        mouseY);
            }
        }
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if (!session.isColorPickerOpen
                ...
                context.renderTooltip(
                        Minecraft.getInstance().font,
                        new net.minecraft.network.chat.TranslatableComponent("color.chestseparators.custom", (i + 1)),
                        mouseX,
                        mouseY);
            }
        }
    ...
    private void drawTabs(GuiGraphics context, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (hover) {
                Component name = (i == 0)
                        ? new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.tab_lines")
                        : (i == 1)
                                ? new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.tab_backgrounds")
                                : new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.tab_combo");
