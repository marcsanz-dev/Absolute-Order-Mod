        ...
        for (int i = 0; i < 16; i++) {
            ...
            if (editor.isHovering(x, y, layout.swatchSize, layout.swatchSize, mx, my)) {
                if (button == 2) {
                    ...
                    editor.showStatus(
                            new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.color_copied"), session.copiedColorRGB);
            ...
            if (editor.isHovering(col3X, y, layout.swatchSize, layout.swatchSize, mx, my)) {
                ...
                if (button == 2) {
                    ...
                    if (session.copiedColorRGB != 0) {
                        ...
                        editor.showStatus(new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.color_pasted"), pastedColor);
