...
public class EditorLayout {
    ...
    public void update(Screen screen, HandledScreenAccessor accessor, int customSidebarYOffset) {
        ...
        if (screen instanceof net.minecraft.client.gui.screens.recipebook.RecipeUpdateListener) {
            net.minecraft.client.gui.screens.recipebook.RecipeUpdateListener rul =
                    (net.minecraft.client.gui.screens.recipebook.RecipeUpdateListener) screen;
