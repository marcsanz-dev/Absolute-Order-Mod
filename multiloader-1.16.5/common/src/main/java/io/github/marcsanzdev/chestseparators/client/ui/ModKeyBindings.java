...
public class ModKeyBindings {
    ...
    public static void register() {
        ...
        KeyBindings.registerKeyBinding(openEditorKey);
        ...
        KeyBindings.registerKeyBinding(showPanelModifierKey);
        ...
        KeyBindings.registerKeyBinding(toggleMagnifierKey);
        ...
        KeyBindings.registerKeyBinding(toggleEditButtonsKey);
        ...
        KeyBindings.registerKeyBinding(pushKey);
        ...
        KeyBindings.registerKeyBinding(pullKey);
        ...
        KeyBindings.registerKeyBinding(autoDepositKey);
    }
}
