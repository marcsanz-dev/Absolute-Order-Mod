...
public class ScreenEditFilter extends AbstractEditorScreen {
    ...
    private void buildUnsavedPopupWidgets() {
        unsavedPopupWidgets.add(new ActionIconButtonWidget(
                ...
                16,
                "1. "
                        + new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.save_and_exit")
                                .getString(),
                null,
                0xFF2D852D,
                () -> {
        ...
        unsavedPopupWidgets.add(new ActionIconButtonWidget(
                ...
                16,
                "2. "
                        + new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.discard_changes")
                                .getString(),
                null,
                0xFF852D2D,
                () -> {
        ...
        unsavedPopupWidgets.add(new ActionIconButtonWidget(
                ...
                240,
                16,
                "3. " + new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.cancel").getString(),
                null,
                0xFF444444,
                () -> {
                    session.isUnsavedPopupOpen = false;
    ...
    private void buildExpelPopupWidgets() {
        expelPopupWidgets.add(new ActionIconButtonWidget(
                ...
                240,
                16,
                "1. " + new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.accept_expel").getString(),
                null,
                0xFF2D852D,
                () -> {
                    ChestConfigManager.getInstance().saveWhitelistSnapshot();
        ...
        expelPopupWidgets.add(new ActionIconButtonWidget(
                ...
                240,
                16,
                "2. " + new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.cancel").getString(),
                null,
                0xFF444444,
                () -> {
                    session.isExpelPopupOpen = false;
    ...
    private void drawGhostRow(
        ...
        Item item = Registry.ITEM.get(net.minecraft.resources.ResourceLocation.tryParse(itemId));
        if (item == null) return;
    ...
    protected void buildWidgets() {
        ...
        WideButtonWidget btnImport = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.import_extracted").getString(),
                ...
                () -> {
                    ...
                    if (isSearching) {
                        ...
                        if (addedCount > 0) editor.playClickSound(1.2f);
                            ...
                            editor.showStatus(
                                    new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.items_already_in_filter"),
                                    ChatFormatting.RED);
                            editor.playClickSound(0.8f);
                        }
                    } else {
                        ...
                        extracted.removeIf(id -> {
                            Item it = Registry.ITEM.get(net.minecraft.resources.ResourceLocation.tryParse(id));
                        ...
                        if (!extracted.isEmpty()) {
                            ...
                            editor.showStatus(
                                    new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.no_new_items_found"), ChatFormatting.RED);
                            editor.playClickSound(0.8f);
                        }
                    }
        ...
        btnImport.tooltipText = new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.import_extracted")
                .getString();
        ...
        WideButtonWidget btnAllowAll = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.allow_all").getString(),
                    ...
                    for (Item item : session.allGameItems)
                        if (editor.isItemAllowedForFilter(item))
                            session.currentAllowedItems.add(
                                    Registry.ITEM.getKey(item).toString());
                    editor.playClickSound(1.0f);
                    session.forceStopPreview = true;
                    session.isPreviewing = false;
                    session.previewItems.clear();
        ...
        btnAllowAll.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.allow_all").getString();
        ...
        WideButtonWidget btnClearAll = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.clear_all").getString(),
        ...
        btnClearAll.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.clear_all").getString();
        ...
        WideButtonWidget btnManual = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.manual_insert").getString(),
        ...
        btnManual.tooltipText = session.ruleManual
                ? new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.manual_active")
                        .getString()
                : new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.manual_inactive")
                        .getString();
        ...
        WideButtonWidget btnShift = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.shift_insert").getString(),
        ...
        btnShift.tooltipText = session.ruleShift
                ? new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.shift_active").getString()
                : new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.shift_inactive")
                        .getString();
        ...
        if (showThirdRule) {
            ...
            if (invFilter) {
                btnHopper.tooltipText = session.ruleHopper
                        ? new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.pickup_active")
                                .getString()
                        : new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.pickup_inactive")
                                .getString();
            } else if (!session.isEntityChest || session.isMinecartChest) {
                btnHopper.tooltipText = session.ruleHopper
                        ? new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.hopper_active")
                                .getString()
                        : new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.rule.hopper_inactive")
                                .getString();
            }
        ...
        btnDelete.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.delete_group").getString();
        ...
        ActionIconButtonWidget btnSave = new ActionIconButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.save").getString(),
        ...
        btnSave.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.save").getString();
        btnSave.texSize = 128;
        ...
        btnCancel.tooltipText =
                new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.cancel").getString();
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        if (!isAnyPopupOpen) {
            Minecraft client = Minecraft.getInstance();
            Component hint = new net.minecraft.network.chat.TranslatableComponent("message.chestseparators.tag_hint");
            context.drawString(
                    client.font,
                    hint,
        ...
        if (isAnyPopupOpen) {
            ...
            Component title = session.isExpelPopupOpen
                    ? new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.expel_items_title")
                    : new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.unsaved_changes_title");
            ...
            Component desc = session.isExpelPopupOpen
                    ? new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.expel_items_desc")
                    : new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.unsaved_changes_desc");
    ...
    private void updateWidgetStates(int mouseX, int mouseY) {
        ...
        importBtn.tooltipText = isSearching
                ? new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.import_search")
                        .getString()
                : new net.minecraft.network.chat.TranslatableComponent("tooltip.chestseparators.desc.import_extracted")
                        .getString();

        String newText = isSearching
                ? new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.import_search").getString()
                : new net.minecraft.network.chat.TranslatableComponent("button.chestseparators.import_extracted").getString();
        ...
        if (session.previewType != 0 && !session.forceStopPreview) {
            if (!session.isPreviewing) {
                ...
                if (session.previewType == 1) {
                    if (isSearching) {
                        for (Item item : session.filteredItems)
                            itemsToPreview.add(Registry.ITEM.getKey(item).toString());
                    } else {
