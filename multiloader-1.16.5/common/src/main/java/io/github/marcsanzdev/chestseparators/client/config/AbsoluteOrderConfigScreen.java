...
public final class AbsoluteOrderConfigScreen {
    ...
    private static IconBooleanListEntry iconToggle(
        ...
        return new IconBooleanListEntry(
                new net.minecraft.network.chat.TranslatableComponent("config.chestseparators." + key),
                value,
                def,
                save,
                new net.minecraft.network.chat.TranslatableComponent("config.chestseparators." + key + ".tooltip"),
                icon);
    }
    ...
    public static Screen buildScreen(Screen parent) {
        ConfigBuilder builder = ConfigBuilder.create()
                ...
                .setTitle(new net.minecraft.network.chat.TranslatableComponent("title.chestseparators.config"));
        ...
        ConfigCategory clientCategory =
                builder.getOrCreateCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.category.client"));
        ...
        interfaceEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.show_left_panel"),
                        GlobalChestConfig.instance.showLeftPanel)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.show_left_panel.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.showLeftPanel = newValue)
                .build());
        interfaceEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.enable_preview_animation"),
                        GlobalChestConfig.instance.enablePreviewAnimation)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.enable_preview_animation.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.enablePreviewAnimation = newValue)
                .build());
        interfaceEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.show_edit_buttons"),
                        GlobalChestConfig.instance.showEditButtons)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.show_edit_buttons.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.showEditButtons = newValue)
                .build());
        interfaceEntries.add(entryBuilder
                .startSubCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.group.toolbar_buttons"), toolbarEntries)
                .setExpanded(false)
                .build());
        interfaceEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.close_on_click_outside"),
                        GlobalChestConfig.instance.closeOnClickOutside)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.close_on_click_outside.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.closeOnClickOutside = newValue)
                .build());
        clientCategory.addEntry(entryBuilder
                .startSubCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.group.interface"), interfaceEntries)
                .setExpanded(false)
                .build());
        ...
        layoutEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.shared_custom_colors"),
                        GlobalChestConfig.instance.sharedCustomColors)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.shared_custom_colors.tooltip"))
        ...
        layoutEntries.add(new IconIntegerSliderEntry(
                new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.line_transparency"),
                0,
                100,
                GlobalChestConfig.instance.lineTransparency,
                100,
                v -> GlobalChestConfig.instance.lineTransparency = v,
                new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.line_transparency.tooltip"),
                ModTextures.ICON_SM_PENCIL));
        layoutEntries.add(new IconIntegerSliderEntry(
                new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.bg_transparency"),
                0,
                100,
                GlobalChestConfig.instance.bgTransparency,
                40,
                v -> GlobalChestConfig.instance.bgTransparency = v,
                new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.bg_transparency.tooltip"),
                ModTextures.ICON_SM_BRUSH));
        clientCategory.addEntry(entryBuilder
                .startSubCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.group.layout"), layoutEntries)
                .setExpanded(false)
                .build());
        ...
        clientCategory.addEntry(entryBuilder
                .startSubCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.group.filters"), filterEntries)
                .setExpanded(false)
                .build());
        ...
        magnifierEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.magnifier_enabled"),
                        GlobalChestConfig.instance.magnifierEnabled)
                .setDefaultValue(false)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.magnifier_enabled.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.magnifierEnabled = newValue)
                .build());
        magnifierEntries.add(entryBuilder
                .startEnumSelector(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.magnifier_shape"),
                ...
                .setEnumNameProvider(shape -> new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.magnifier_shape."
                        + ((Enum<?>) shape).name().toLowerCase()))
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.magnifier_shape.tooltip"))
        ...
        magnifierEntries.add(iconToggle(
                ...
                ModTextures.ICON_SM_COMBO));
        clientCategory.addEntry(entryBuilder
                .startSubCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.group.magnifier"), magnifierEntries)
                .setExpanded(false)
                .build());
        ...
        autoDepositEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.lock_hotbar_on_reorder"),
                        GlobalChestConfig.instance.lockHotbarOnReorder)
                .setDefaultValue(true)
                // Two-line tooltip: a plain first line, then a dimmed clarification underneath.
                .setTooltip(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.lock_hotbar_on_reorder.tooltip"),
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.lock_hotbar_on_reorder.tooltip2")
                                .withStyle(ChatFormatting.DARK_GRAY))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.lockHotbarOnReorder = newValue)
                .build());
        autoDepositEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_enabled"),
                        GlobalChestConfig.instance.autoDepositEnabled)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_enabled.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.autoDepositEnabled = newValue)
                .build());
        autoDepositEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_double_sneak"),
                        GlobalChestConfig.instance.autoDepositDoubleSneak)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_double_sneak.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.autoDepositDoubleSneak = newValue)
                .build());
        autoDepositEntries.add(entryBuilder
                .startIntSlider(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_radius"),
                        GlobalChestConfig.instance.autoDepositRadius,
                        3,
                        32)
                .setDefaultValue(8)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_radius.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.autoDepositRadius = newValue)
                .build());
        autoDepositEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_through_walls"),
                        GlobalChestConfig.instance.autoDepositThroughWalls)
                .setDefaultValue(false)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_through_walls.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.autoDepositThroughWalls = newValue)
                .build());
        autoDepositEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_animation"),
                        GlobalChestConfig.instance.autoDepositAnimation)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_animation.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.autoDepositAnimation = newValue)
                .build());
        autoDepositEntries.add(entryBuilder
                .startBooleanToggle(
                        new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_trail"),
                        GlobalChestConfig.instance.autoDepositTrail)
                .setDefaultValue(true)
                .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.auto_deposit_trail.tooltip"))
                .setSaveConsumer(newValue -> GlobalChestConfig.instance.autoDepositTrail = newValue)
                .build());
        clientCategory.addEntry(entryBuilder
                .startSubCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.group.autodeposit"), autoDepositEntries)
                .setExpanded(false)
                .build());
        ...
        if (Minecraft.getInstance().hasSingleplayerServer()) {
            ConfigCategory serverCategory =
                    builder.getOrCreateCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.category.server"));

            serverCategory.addEntry(entryBuilder
                    .startBooleanToggle(
                            new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.expel_invalid_items"),
                            GlobalChestConfig.instance.expelInvalidItems)
                    .setDefaultValue(false)
                    .setTooltip(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.expel_invalid_items.tooltip"))
        ...
        ConfigCategory hotkeysCategory =
                builder.getOrCreateCategory(new net.minecraft.network.chat.TranslatableComponent("config.chestseparators.category.hotkeys"));
        ...
        BiConsumer<KeyMapping, String> addKeyEntry = (keyMapping, translationKey) -> {
            ...
            hotkeysCategory.addEntry(entryBuilder
                    .startKeyCodeField(new net.minecraft.network.chat.TranslatableComponent(translationKey), current)
                    .setDefaultValue(keyMapping.getDefaultKey())
                    .setKeySaveConsumer(newKey -> {
                        keyMapping.setKey(newKey);
                        KeyMapping.resetMapping();
                    })
                    .setTooltip(new net.minecraft.network.chat.TranslatableComponent(translationKey + ".tooltip"))
                    .build());
        };
