...
final class FilterPanelRenderer {
    ...
    void drawLeftPanel(GuiGraphics context, int mouseX, int mouseY) {
        ...
        if (session.isPreviewing) {
            if (session.previewType == 1)
                context.drawString(
                        ...
                        new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.new_detected", activeListToRender.size()),
                        (int) ((listX + 8) / scaleC),
                        (int) ((listY + 9) / scaleC),
                        0xFF55FF55,
                        false);
                ...
                context.drawString(
                        Minecraft.getInstance().font,
                        new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.allowing_all", activeListToRender.size()),
                        (int) ((listX + 8) / scaleC),
                        (int) ((listY + 9) / scaleC),
                        0xFF55FF55,
                        false);
                ...
                context.drawString(
                        Minecraft.getInstance().font,
                        new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.clearing", activeListToRender.size()),
                        (int) ((listX + 8) / scaleC),
                        (int) ((listY + 9) / scaleC),
                        0xFFFF5555,
                        false);
            ...
            context.drawString(
                    Minecraft.getInstance().font,
                    new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.allowed", allowedCount),
                    (int) ((listX + 8) / scaleC),
                    (int) ((listY + 5) / scaleC),
                    0xFF55FF55,
                    false);
            context.drawString(
                    Minecraft.getInstance().font,
                    new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.blocked", blockedCount),
                    (int) ((listX + 8) / scaleC),
                    (int) ((listY + 13) / scaleC),
                    0xFFFF5555,
                    false);
        ...
        for (int i = 0; i < visibleCount; i++) {
            ...
            Item item = Registry.ITEM.get(ResourceLocation.tryParse(itemIdStr));
    ...
    void drawMainPanel(GuiGraphics context, int mouseX, int mouseY) {
        ...
        String tabTitle = activeTabInfo != null
                ...
                : new net.minecraft.network.chat.TranslatableComponent("gui.chestseparators.edit_filter_rules").getString();
