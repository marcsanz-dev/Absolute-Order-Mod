...
final class GroupBlobRenderer {
    ...
    void renderWhitelistGroups(GuiGraphicsExtractor context, int mouseX, int mouseY) {
    ...
    private static void fillRegion(
            GuiGraphicsExtractor c, int x0, int y0, int x1, int y1, int base, int tint, List<int[]> tintSquares) {
    ...
    private void drawBlobGroup(GuiGraphicsExtractor context, Set<Integer> groupSlots, int colorARGB, int guiX, int guiY) {
