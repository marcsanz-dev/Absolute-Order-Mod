...
public class ChestSeparatorsEditor {
    ...
    public void init() {
        ...
        this.whitelistButton = new io.github.marcsanzdev.chestseparators.client.ui.widgets.ToolButtonWidget(
                ...
                Component.translatable("tooltip.chestseparators.whitelist_mode").getString(),
                () -> {
        ...
        net.minecraft.resources.Identifier[] toolbarIcons = {
        ...
        net.minecraft.core.registries.BuiltInRegistries.CREATIVE_MODE_TAB.forEach(group -> {
            net.minecraft.resources.Identifier id = net.minecraft.core.registries.BuiltInRegistries.CREATIVE_MODE_TAB.getKey(group);
            if (id == null) return;
    ...
    private static boolean isNonSurvivalItem(Item item) {
        ...
        return block == net.minecraft.world.level.block.Blocks.SPAWNER
                || block == net.minecraft.world.level.block.Blocks.TRIAL_SPAWNER
                        ...
                        if (!session.filteredItems.contains(item)
                            ...
                            if (isSearching) {
                                ...
                                if (lowerQuery.startsWith("#")) {
                                    ...
                                    matches = item.getName(item.getDefaultInstance())
                                            .getString()
                                            .toLowerCase()
                                            .contains(lowerQuery);
                                }
        ...
        for (String id : session.currentAllowedItems) {
            ...
            if (item != null) {
                ...
                if (wlSearch.isEmpty()) {
                    ...
                    matches = item.getName(item.getDefaultInstance()).getString().toLowerCase().contains(wlSearch);
                }
                ...
                if (!prioritizedSlots.isEmpty()) {
                    ...
                    for (net.minecraft.world.inventory.Slot targetSlot : prioritizedSlots) {
                        ...
                        if (spaceLeft > 0) {
                            ...
                            interactionManager.handleContainerInput(
                                    syncId, targetSlot.index, 0, net.minecraft.world.inventory.ContainerInput.PICKUP, player);
                    ...
                    if (pickedUp && remainingOnCursor > 0) {
                        interactionManager.handleContainerInput(
                                syncId, playerSlot.index, 0, net.minecraft.world.inventory.ContainerInput.PICKUP, player);
                    }
                }
            }
        }
