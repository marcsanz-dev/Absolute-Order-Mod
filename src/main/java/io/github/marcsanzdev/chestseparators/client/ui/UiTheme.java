...
public final class UiTheme {
     ...
     */
    public static void tab(DrawContext c, int x, int y, int w, int h, boolean hover, boolean active, int attach) {
     ...
     */
    public static void scrollbar(DrawContext c, int x, int y, int w, int h, int thumbY, int thumbH) {
        inset(c, x, y, w, h);
        int col = 0x70FFFFFF;
        int tx = x + 1;
        int tw = w - 2;
     ...
     * their aspect ratio. ALWAYS pair with {@code context.getMatrices().popMatrix()}.
     */
    public static void pushActiveContent(DrawContext c, int x, int y, int w, int h) {
