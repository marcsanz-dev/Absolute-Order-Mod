...
final class ColorPickerGradients {
    ...
    static void drawSaturationValueBox(DrawContext context, int x, int y, int w, int h, float hue) {
        int step = 2;
    ...
    static void drawHueBar(DrawContext context, int x, int y, int w, int h) {
        for (int i = 0; i < h; i++) {
            float hue = (float) i / h;
