...
public class ScreenEditFilter extends AbstractEditorScreen {
    ...
    protected void buildWidgets() {
        ...
        if (!session.isEnderChest && !session.isEntityChest) btnHopper.tooltipText = session.ruleHopper ? Text.translatable("tooltip.chestseparators.rule.hopper_active").getString() : Text.translatable("tooltip.chestseparators.rule.hopper_inactive").getString();
