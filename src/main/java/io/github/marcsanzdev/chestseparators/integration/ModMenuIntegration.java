...
public class ModMenuIntegration implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            // ================= FILTERS =================
            // Each default-rule toggle carries the same icon its rule button uses in the filter editor. The
            // third rule is shown twice — Hopper (chest filters) and Pick Up (inventory filters) — since they
            // default independently even though they share one stored flag.
