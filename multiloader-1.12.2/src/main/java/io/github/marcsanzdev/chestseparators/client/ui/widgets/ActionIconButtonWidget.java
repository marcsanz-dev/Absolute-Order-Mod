    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        if (textWidth * scale > availableTextWidth) {
            ...
            if (scale < 0.60f) {
                ...
                displayText = Minecraft.getMinecraft().fontRenderer.trimStringToWidth(label, maxTextWidth - 8) + "...";
            }
        }

        int scaledTextWidth = (int) (Minecraft.getMinecraft().fontRenderer.getStringWidth(displayText) * scale);
        ...
        context.drawString(Minecraft.getMinecraft().fontRenderer, displayText, 0, 0, textColor, true);
