 ...
 */
public final class InventoryFiltersPayload implements CsPayload {

    private final Map<Integer, SlotWhitelist> filters;

    public InventoryFiltersPayload(Map<Integer, SlotWhitelist> filters) {
    ...
    public boolean equals(Object o) {
        ...
        InventoryFiltersPayload x = (InventoryFiltersPayload) o;
        return java.util.Objects.equals(filters, x.filters);
    }
    ...
    public String toString() {
        return "InventoryFiltersPayload[filters=" + filters + "]";
    }

    public static final ResourceLocation ID = new ResourceLocation("chestseparators", "inventory_filters");

    public static InventoryFiltersPayload read(PacketBuffer buf) {
