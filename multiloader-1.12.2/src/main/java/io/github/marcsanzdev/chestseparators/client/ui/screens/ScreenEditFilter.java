...
public class ScreenEditFilter extends AbstractEditorScreen {
    ...
    private void buildUnsavedPopupWidgets() {
        unsavedPopupWidgets.add(new ActionIconButtonWidget(
                ...
                16,
                "1. "
                        + new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.save_and_exit")
                                .getFormattedText(),
                null,
                0xFF2D852D,
                () -> {
        ...
        unsavedPopupWidgets.add(new ActionIconButtonWidget(
                ...
                16,
                "2. "
                        + new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.discard_changes")
                                .getFormattedText(),
                null,
                0xFF852D2D,
                () -> {
    ...
    private void buildExpelPopupWidgets() {
        expelPopupWidgets.add(new ActionIconButtonWidget(
                ...
                240,
                16,
                "1. " + new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.accept_expel").getFormattedText(),
                null,
                0xFF2D852D,
                () -> {
                    ChestConfigManager.getInstance().saveWhitelistSnapshot();
        ...
        expelPopupWidgets.add(new ActionIconButtonWidget(
                ...
                240,
                16,
                "2. " + new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.cancel").getFormattedText(),
                null,
                0xFF444444,
                () -> {
                    session.isExpelPopupOpen = false;
    ...
    private void drawReorderGhost(GuiGraphics context) {
        ...
        if (session.reorderDragItem != null) {
            ...
            float t = net.minecraft.util.math.MathHelper.clamp(
    ...
    private void drawGhostRow(
        ...
        int rowH = 18;
        shrink = net.minecraft.util.math.MathHelper.clamp(shrink, 0f, 1f);
        float scale = 0.9f * shrink;
        int barAlpha = (int) (0xFF * net.minecraft.util.math.MathHelper.clamp(presence, 0f, 1f));
        ...
        if (client.fontRenderer.getStringWidth(name) > maxNameW) {
            name = client.fontRenderer.trimStringToWidth(name, maxNameW - 6) + "...";
        }
        context.drawString(
                client.fontRenderer,
                name,
        ...
        context.drawString(
                client.fontRenderer, "x", rowW - 13, 5, (barAlpha << 24) | (danger ? 0xFF5555 : 0xAAAAAA), false);
        context.pose().popPose();
    ...
    public void commitReorder(double mouseX, double mouseY) {
        ...
        if (removal) {
            ...
            editor.playUiSound(net.minecraft.init.SoundEvents.ENTITY_ITEMFRAME_REMOVE_ITEM, 1.0f);
            return;
        }
        ...
        if (from < 0) editor.playUiSound(net.minecraft.init.SoundEvents.ENTITY_ITEMFRAME_ADD_ITEM, 1.0f);
    ...
    private void updateReorderAutoScroll() {
        ...
        if (session.reorderMouseY < top + edge) {
            session.listScrollY = net.minecraft.util.math.MathHelper.clamp(session.listScrollY - step, 0, maxScroll);
    ...
    protected void buildWidgets() {
        ...
        WideButtonWidget btnImport = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.import_extracted").getFormattedText(),
                ...
                () -> {
                    ...
                    if (isSearching) {
                        ...
                        if (addedCount > 0) editor.playClickSound(1.2f);
                            ...
                            editor.showStatus(
                                    new net.minecraft.util.text.TextComponentTranslation("message.chestseparators.items_already_in_filter"),
                                    TextFormatting.RED);
                            editor.playClickSound(0.8f);
                        }
                    } else {
                        ...
                        if (!extracted.isEmpty()) {
                            ...
                            editor.showStatus(
                                    new net.minecraft.util.text.TextComponentTranslation("message.chestseparators.no_new_items_found"), TextFormatting.RED);
                            editor.playClickSound(0.8f);
                        }
                    }
        ...
        btnImport.tooltipText = new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.import_extracted")
                .getFormattedText();
        ...
        WideButtonWidget btnAllowAll = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.allow_all").getFormattedText(),
        ...
        btnAllowAll.tooltipText =
                new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.allow_all").getFormattedText();
        ...
        WideButtonWidget btnClearAll = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.clear_all").getFormattedText(),
        ...
        btnClearAll.tooltipText =
                new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.clear_all").getFormattedText();
        ...
        WideButtonWidget btnManual = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.manual_insert").getFormattedText(),
        ...
        btnManual.tooltipText = session.ruleManual
                ? new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.manual_active")
                        .getFormattedText()
                : new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.manual_inactive")
                        .getFormattedText();
        ...
        WideButtonWidget btnShift = new WideButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.shift_insert").getFormattedText(),
        ...
        btnShift.tooltipText = session.ruleShift
                ? new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.shift_active").getFormattedText()
                : new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.shift_inactive")
                        .getFormattedText();
        ...
        if (showThirdRule) {
            ...
            if (invFilter) {
                btnHopper.tooltipText = session.ruleHopper
                        ? new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.pickup_active")
                                .getFormattedText()
                        : new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.pickup_inactive")
                                .getFormattedText();
            } else if (!session.isEntityChest || session.isMinecartChest) {
                btnHopper.tooltipText = session.ruleHopper
                        ? new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.hopper_active")
                                .getFormattedText()
                        : new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.rule.hopper_inactive")
                                .getFormattedText();
            }
        ...
        ActionIconButtonWidget btnDelete = new ActionIconButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.delete").getFormattedText(),
        ...
        btnDelete.tooltipText =
                new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.delete_group").getFormattedText();
        ...
        ActionIconButtonWidget btnSave = new ActionIconButtonWidget(
                ...
                btnW,
                bH,
                new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.save").getFormattedText(),
                ...
                () -> {
                    ...
                    if (io.github.marcsanzdev.chestseparators.config.GlobalChestConfig.instance.expelInvalidItems
                        ...
                        for (int slotIdx : session.selectedSlots) {
                            if (slotIdx >= 0
                                    && slotIdx
                                            < editor.accessor.getHandler().inventorySlots.size()) {
        ...
        btnSave.tooltipText =
                new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.save").getFormattedText();
        btnSave.texSize = 128;
        ...
        btnCancel.tooltipText =
                new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.cancel").getFormattedText();
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        if (!isAnyPopupOpen) {
            Minecraft client = Minecraft.getMinecraft();
            ITextComponent hint = new net.minecraft.util.text.TextComponentTranslation("message.chestseparators.tag_hint");
            context.drawString(
                    client.fontRenderer,
                    hint,
                    (layout.screenWidth - client.fontRenderer.getStringWidth(hint.getFormattedText())) / 2,
        ...
        if (isAnyPopupOpen) {
            ...
            ITextComponent title = session.isExpelPopupOpen
                    ? new net.minecraft.util.text.TextComponentTranslation("gui.chestseparators.expel_items_title")
                    : new net.minecraft.util.text.TextComponentTranslation("gui.chestseparators.unsaved_changes_title");
            ...
            context.drawCenteredString(client.fontRenderer, title, 0, 0, titleColor);
            context.pose().popPose();

            ITextComponent desc = session.isExpelPopupOpen
                    ? new net.minecraft.util.text.TextComponentTranslation("gui.chestseparators.expel_items_desc")
                    : new net.minecraft.util.text.TextComponentTranslation("gui.chestseparators.unsaved_changes_desc");

            if (session.isExpelPopupOpen) {
                int descY = layout.conflictPopupY + 26;
                for (String line : client.fontRenderer.listFormattedStringToWidth(desc.getFormattedText(), maxContentWidth)) {
                    ...
                    context.drawString(
                            ...
                            false);
                    descY += client.fontRenderer.FONT_HEIGHT + 1;
                }
            } else {
    ...
    private void updateWidgetStates(int mouseX, int mouseY) {
        ...
        importBtn.tooltipText = isSearching
                ? new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.import_search")
                        .getFormattedText()
                : new net.minecraft.util.text.TextComponentTranslation("tooltip.chestseparators.desc.import_extracted")
                        .getFormattedText();

        String newText = isSearching
                ? new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.import_search").getFormattedText()
                : new net.minecraft.util.text.TextComponentTranslation("button.chestseparators.import_extracted").getFormattedText();
        ...
        if (session.previewType != 0 && !session.forceStopPreview) {
            if (!session.isPreviewing) {
                ...
                if (session.previewType == 1) {
                    if (isSearching) {
                        for (Item item : session.filteredItems)
                            itemsToPreview.add(item.getRegistryName().toString());
                    } else {
    ...
    public boolean keyPressed(io.github.marcsanzdev.chestseparators.client.input.KeyEvent input) {
        ...
        if (isSearchFocused) {
            // 1.12.2: GuiTextField combines char + control keys into textboxKeyTyped(char, keyCode); the
            // keyPressed path only carries control keys, so pass a null char and route by keyCode.
            if (editor.searchBox.textboxKeyTyped('\0', input.key())) return true;
            if (input.key() != org.lwjgl.input.Keyboard.KEY_ESCAPE) return true;
        }
        if (isWhitelistSearchFocused) {
            if (editor.whitelistSearchBox.textboxKeyTyped('\0', input.key())) return true;
            if (input.key() != org.lwjgl.input.Keyboard.KEY_ESCAPE) return true;
        }
        ...
        if (!isSearchFocused && !isWhitelistSearchFocused && editor.searchBox != null) {
            // TODO(1.12.2 port): keyInventory match — keyBindInventory.getKeyCode() is an LWJGL key code
            // while KeyEvent.key() is a GLFW code, so the two namespaces do not line up until the input
            // boundary translates them.
            if (input.key() != org.lwjgl.input.Keyboard.KEY_NONE
                    && Minecraft.getMinecraft().gameSettings.keyBindInventory.getKeyCode() == input.key()) {
        ...
        if (!isSearchFocused && !isWhitelistSearchFocused) {
            if (input.key() == org.lwjgl.input.Keyboard.KEY_UP || input.key() == org.lwjgl.input.Keyboard.KEY_DOWN) {
                float scrollAmount = 18f * 2;
                int direction = (input.key() == org.lwjgl.input.Keyboard.KEY_UP) ? -1 : 1;
    ...
    public boolean charTyped(io.github.marcsanzdev.chestseparators.client.input.CharacterEvent input) {
        // 1.12.2: the typed character goes through textboxKeyTyped with no keyCode.
        if (editor.searchBox != null && editor.searchBox.isFocused()) return editor.searchBox.textboxKeyTyped((char) input.codepoint(), 0);
        if (editor.whitelistSearchBox != null && editor.whitelistSearchBox.isFocused())
            return editor.whitelistSearchBox.textboxKeyTyped((char) input.codepoint(), 0);
        ...
        if (editor.searchBox != null) {
            ...
            if (isOnSearchTab()) {
                editor.searchBox.setFocused(true);
                if (editor.whitelistSearchBox != null) editor.whitelistSearchBox.setFocused(false);
                return editor.searchBox.textboxKeyTyped((char) input.codepoint(), 0);
            }
        }
        return false;
    }
    ...
    private void switchToSearchTab() {
        for (int i = 0; i < session.availableTabs.size(); i++) {
            io.github.marcsanzdev.chestseparators.client.ui.EditorSessionData.CreativeTabInfo tab = session.availableTabs.get(i);
