                ...
                if (session.currentTab == 1 || session.currentTab == 2) {
                    ...
                    if (toolMode == 1) {
                        ...
                        while (session.tracePath.size() >= 2) {
                            ...
                            double cRelX = mouseX - (guiX + currSlot.xPos);
                            double cRelY = mouseY - (guiY + currSlot.yPos);
                        ...
                        if (rawStep != null && !rawStep.isEmpty()) {
                            if (!session.tracePath.contains(rawStep)) {
                                ...
                                double rRelX = mouseX - (guiX + rawSlot.xPos);
                                double rRelY = mouseY - (guiY + rawSlot.yPos);
