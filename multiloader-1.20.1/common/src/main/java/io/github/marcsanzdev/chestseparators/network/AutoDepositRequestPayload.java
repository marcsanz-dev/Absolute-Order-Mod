...
public record AutoDepositRequestPayload(
    ...
    public static AutoDepositRequestPayload read(FriendlyByteBuf buf) {
    ...
    private static void writeWlMap(FriendlyByteBuf buf, Map<Integer, SlotWhitelist> map) {
    ...
    private static Map<Integer, SlotWhitelist> readWlMap(FriendlyByteBuf buf) {
    ...
    private static Map<UUID, Map<Integer, SlotWhitelist>> readEntityMap(FriendlyByteBuf buf) {
        int size = buf.readVarInt();
